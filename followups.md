...
- [ ] **Freshman roster: corrupt source row** in `docs/2025 McNeil Football Rosters - Freshmen.pdf` — one row in the left column has neither jersey# nor name, just position WR/LB grade 9. Skipped by migration 031. Ask coaching staff who that player is (or confirm it should stay out). The 8 originally-uncolored players were resolved by migration 033 (Green: #4 Shin, #71 Pelosi, #73 Omagbon; Blue: #19 Brown, #53 Cocke, #55 Solages, #63 Llamas, #72 McCallister).
