...
- [ ] **Console-error sweep on `/` and `/sponsors`.** Triaged 2026-05-23: 3 known-404 RSC prefetches that Next.js fires automatically when the homepage's `<Link>`s enter the viewport. As of 2026-05-25: `/boosters/sponsor` (built 2026-05-23, `e6a9eb8`) and `/boosters/volunteer` (built 2026-05-24, `3212912`) are now live. Only `/boosters/donate` still 404s. Re-check console after that ships; close this item when zero prefetch 404s remain.
