...
## Pre-cutover content
- [ ] Replace 2025-26 review-period seed with real 2026-27 roster before public cutover. Includes: insert new rosters/practice_schedules/coaches rows at year='2026-27', migrate or insert new player rows, update site_settings.current_year='2026-27' in the same migration so headers and queries flip together. Current state: migrations 029/031 seeded V=27 + JV=65 + F-Green=19 + F-Blue=22 players under 2025-26 rosters; migration 032 seeded the real 2025 V/JV/F schedule (46 games, all `result_status='scheduled'`). Board stays at 2026-27 via site_settings.current_board_year.
- [ ] **Freshman roster: 8 uncolored players** in `docs/2025 McNeil Football Rosters - Freshmen.pdf` (#4 Conan Shin, #19 Lamonte Brown, #53 Augustus Cocke, #55 Jaye Solages, #63 Mark Llamas, #71 Jaxon Pelosi, #72 Brennan McCallister, #73 Favor Omagbon) have no Green/Blue team color in the source PDF. Not seeded by migration 031. Ask coaching staff which team each belongs to (or whether they were dropped) before public cutover. Plus the PDF has one extra row with no jersey# and no name (position WR/LB, grade 9) — corrupt source row, skipped.
