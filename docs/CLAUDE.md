...
## Status (2026-05-23 — /boosters/sponsor + /boosters/committees shipped, nav cleanup, /sponsors navy band)
...
| 5. Public collection routes (expanded) | in progress | `/boosters/join` + `/boosters/members` + `/sponsors` + `/boosters/sponsor` + `/boosters/committees` live. Remaining: `/news`, `/boosters/donate`, `/boosters/volunteer`, `/boosters/board`, `/boosters/events`, `/boosters/documents`. (Board nav entry removed from header 2026-05-23; route was never built. Decide at next session whether to build the route or leave nav-only.) |
