...
## Status (2026-05-24 — /boosters/volunteer shipped, /boosters/members Join button, /boosters hero tightened, BOOSTER_LINKS lifted)
...
| 5. Public collection routes (expanded) | in progress | `/boosters/join` + `/boosters/members` + `/sponsors` + `/boosters/sponsor` + `/boosters/committees` + `/boosters/volunteer` live. Remaining: `/news`, `/boosters/donate`, `/boosters/board`, `/boosters/events`, `/boosters/documents`. (Board nav entry removed from header 2026-05-23; route was never built. Decide at next session whether to build the route or leave nav-only.) |
